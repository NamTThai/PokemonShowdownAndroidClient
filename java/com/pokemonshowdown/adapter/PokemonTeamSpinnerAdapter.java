 ...
 */
public class PokemonTeamSpinnerAdapter extends ArrayAdapter<PokemonTeam> {

    private Context mContext;
    private List<PokemonTeam> mPokemonTeamList;

    public PokemonTeamSpinnerAdapter(Context getContext, List<PokemonTeam> userListData) {
